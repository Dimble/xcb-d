...
extern(C) xcb_extension_t xcb_screensaver_id;

enum XcbScreensaverKind {
    BLANKED,
    INTERNAL,
    EXTERNAL
}
...
const ubyte XCB_SCREENSAVER_QUERY_VERSION = 0;
...
const ubyte XCB_SCREENSAVER_QUERY_INFO = 1;
...
const ubyte XCB_SCREENSAVER_SELECT_INPUT = 2;
...
const ubyte XCB_SCREENSAVER_SET_ATTRIBUTES = 3;
...
const ubyte XCB_SCREENSAVER_UNSET_ATTRIBUTES = 4;
...
const ubyte XCB_SCREENSAVER_SUSPEND = 5;
...
const ubyte XCB_SCREENSAVER_NOTIFY = 0;
